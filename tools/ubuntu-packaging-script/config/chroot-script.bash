...
then
	sed '/Depends/c \Depends: libboost-date-time1.42.0 (>= 1.42.0), libboost-filesystem1.42.0 (>= 1.42.0), libboost-thread1.42.0 (>= 1.42.0), libboost-regex1.42.0 (>= 1.42.0), libboost-program-options1.42.0 (>= 1.42.0), libpocofoundation9 (>= 1.3.4), libpoconet9 (>= 1.3.4), libpocoutil9 (>= 1.3.4), libqt4-script (>= 4.6.1), libqt4-webkit (>= 4.6.1), libqt4-scripttools (>= 4.6.1), libopenal1 (>= 1.1.0), libogremain-1.6.4 (>= 1.6.1), libopenjpeg2 (>= 1.3), libxmlrpc-epi0, libboost-test1.42.0 (>=1.42.0), libcurl3-gnutls, libqtscript4-uitools, libqtscript4-gui, libqtscript4-webkit, libqt4-webkit, libqt4-svg, libqt4-sql, python2.6, libqt4-xmlpatterns, libpython2.6' /$REX_DIR/config/control_$BRANCH > tmpfile ; mv tmpfile /$REX_DIR/config/control_$BRANCH
else
